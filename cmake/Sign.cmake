...
function(sign_with_timestamp target)
    ...
    add_custom_command(TARGET ${target}
        COMMAND "${SIGNTOOL}" sign /v /f "${CERTIFICATE_PATH}/${CERTIFICATE_NAME}.pfx" /t ${TIMESTAMP_SERVER} $<TARGET_FILE:${target}>
...
function(sign_without_timestamp target)
    ...
    add_custom_command(TARGET ${target}
        COMMAND "${SIGNTOOL}" sign /debug /v /fd SHA256 "${CERTIFICATE_PATH}/${CERTIFICATE_NAME}.pfx" $<TARGET_FILE:${target}>
        COMMENT "Signing $<TARGET_FILE:${target}>..."
    )
endfunction()
