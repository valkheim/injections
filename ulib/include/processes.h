...
namespace ul
{
  ...
  [[nodiscard]] auto with_process_using_enumprocess(std::string_view&& requested_name, std::function<::ul::walk_t(::ul::Process)> callback) -> bool;
  [[nodiscard]] auto with_process_using_toolhelp(std::string_view&& requested_name, std::function<::ul::walk_t(::ul::Process)> callback) -> bool;
  [[nodiscard]] auto with_process_using_wts(std::string_view&& requested_name, std::function<::ul::walk_t(::ul::Process)> callback) -> bool;
}  // namespace ul